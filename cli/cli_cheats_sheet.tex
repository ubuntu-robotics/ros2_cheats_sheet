...
%
\rosverb{interface} Various ROS interfaces
(actions/topics/services)-related sub-commands.
...
%
\begin{tabularx}{\linewidth}{lX}
\smallhspace \rossubverb{list}     & List all interface types available.                            \\
\smallhspace \rossubverb{package}  & Output a list of available interface types within one package. \\
\smallhspace \rossubverb{packages} & Output a list of packages that provide interfaces.             \\
\smallhspace \rossubverb{show}     & Output the interface definition.
\end{tabularx}
%
Examples:
\\
