...
\terminal{colcon test --packages-select demo\_nodes\_cpp} \\
%
Test a single package including dependencies,
and print immediately on terminal:\\
\terminal{colcon test --packages-select demo\_nodes\_cpp
\terminalinebreak~\ddash event-handlers console\_direct+ \ddash pytest-args -s}
%
